...
/**
 * 游戏账号审核包赔个人详情Mapper接口
 * 
 * @author ruoyi
 * @date 2022-05-08
 */
public interface AccountPersonalDetailsMapper 
{
    /**
     * 查询游戏账号审核包赔个人详情
     * 
    ...
    /**
     * 根据条件查询审核包赔信息
     * @param accountPersonalDetails
     * @return
     */
    public AccountPersonalDetails selectAccountPersonalDetails(AccountPersonalDetails accountPersonalDetails);
