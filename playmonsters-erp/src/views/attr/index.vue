  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['account:attr:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['account:attr:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="属性1" prop="att1">
          <el-input v-model="form.att1" placeholder="请输入属性1" />
        </el-form-item>
        <el-form-item label="属性2" prop="att2">
          <el-input v-model="form.att2" placeholder="请输入属性2" />
        </el-form-item>
...
<script>
import { listAttr, getAttr, delAttr, addAttr, updateAttr, exportAttr } from "@/api/info/attr";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除属性配置编号为"' + ids + '"的数据项？').then(function() {
        return delAttr(ids);
      }).then(() => {
        this.getList();
    ...
    handleExport() {
      ...
      this.$modal.confirm('是否确认导出所有属性配置数据项？').then(() => {
