<template>
  <div class="app-container">
    <el-form
      ...
      label-width="68px"
    >
      <el-form-item label="供货人ID" prop="superId">
        <el-select
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['account:price:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['account:price:export']"
          >导出</el-button
        >
      </el-col>
      <right-toolbar
    ...
    >
      ...
      <el-table-column label="加价比例" align="center" prop="rise" />
...
<script>
import { cmdPoollist, getCmdSupplyList } from "@/api/info/info";
import {
  listPrice,
  getPrice,
  delPrice,
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除批量加价编号为"' + ids + '"的数据项？')
        .then(function () {
          return delPrice(ids);
        })
        .then(() => {
