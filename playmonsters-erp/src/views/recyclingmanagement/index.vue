  ...
  <div>
    <el-card>
      ...
      <div>
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="backUserName" label="回收人" align="center">
          </el-table-column>
    ...
    >
      <el-form :model="form" :rules="rules" ref="formName" label-width="81px">
        ...
        <el-form-item label="回收人" prop="backUserName">
          <el-input
            style="width: 250px"
...
<script>
import { getList, addList, getoneListdetail, editList, deleteList, daochuList } from '../../api/recyclingmanagement/index'
export default {
  data() {
    return {
      formInline: {
      ...
      rules: {
        ...
        backUserName: [
          { required: true, message: '请输入回收人', trigger: 'change' }
        ],
        leaderUserName: [
